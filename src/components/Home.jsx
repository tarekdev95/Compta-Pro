  ...
  const modules = [
    {
      icon: '💰',
      title: 'Comptes',
      description: 'Gérez vos comptes bancaires et financiers facilement'
    },
    {
      icon: '📊',
      title: 'Transactions',
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-8 text-white">
            <h2 className="text-4xl font-bold mb-4">Bienvenue sur Compta-Pro</h2>
            <p className="text-lg opacity-90">Gérez facilement la comptabilité de votre entreprise avec notre solution complète et intuitive.</p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card text-center">
            ...
            <p className="text-gray-600">Transactions ce mois</p>
          </div>
          <div className="card text-center">
        ...
        {/* Modules Grid */}
        <section>
          <h3 className="text-2xl font-bold text-gray-800 mb-8">Fonctionnalités Principales</h3>
